...
${Object.keys(cardsByWave)
  ...
  .map((w) => {
    const label = {
      5: 'Wave 5 — PROPOSED (rooms & breaches: sectioned maps, crate clusters, furniture integrated into wall structures, breakable double doors — designer brief 2026-08-26)',
