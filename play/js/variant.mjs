 ...
 * spanning the patch width, skipping wall squares. A walled back-row slot
 * suppresses BOTH the piece and that file's pawn (walls eat slots — the
 * semantics every Phase 0 sweep shipped with).
 */
