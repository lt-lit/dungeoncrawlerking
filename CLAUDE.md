...
15. **The vendored pair is a MATCHED SET built from one patch, two trees,
    two toolchains — and SEVEN patches now: dead-squares, thread-stack,
    portals, wall-kinds, hammer, portals-body, portals-cast, applied in that
    order (portals-body is portals-v2's body rule with the tunnel half
    removed and portals-cast is portals-v3 rebased, since the tunnel's
    retirement 2026-09-19).** ffish comes from FSF mainline (`src/Makefile_js`,
