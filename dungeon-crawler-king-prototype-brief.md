...
### 4.9 The ice spell — slippery squares, the slide and the pit `_` `[BUILT 2026-09-20 — designer-specified rules; engine substrate is engine/patches/ice.patch, the eighth patch; one scroll a side for the stress test; the phone verdict is owed]`
