...
- Furniture × the Gods (§4.6): v3 gave the gods their crate policy (weaken creates, breach destroys — §4.5); still open are the **terrain-conservation brake** (designer 2026-09-01: a running wall/furniture census against the authored proportions so breach cannot strip rooms bare — Phase 1.5(b)) and the restlessness meter's weight for furniture smashes — full capture credit would let the player farm crates to keep the gods asleep.
