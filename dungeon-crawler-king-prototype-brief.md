...
**Open, the designer's:** whether a hit frees an ice block in one, or a block takes two like a wall; whether the lethal fire cast is its own card or the ignite card with a body count; which four transitions are in the first table.

**The card UI — Phase 3.2 `[PROPOSED 2026-09-25, not built; designer: "These little buttons aren't gonna cut it. I wanna take notes from other card wielding games like mtg arena and hearthstone. Probably cast spells by dragging them from the hand to the field, that kind of thing"]`.** What transfers from Hearthstone and MTG Arena on a phone, and what does not:
...
- **Phase 3 — The loop `[OPENED 2026-09-25 with THE DECK — §4.10; numbered the same day, designer: "give these future steps phase numbers that fit in with the current overarching plan"]`.** Rewards, collection, level scaling, floor transitions, the first full runs — and the collection IS the deck, so Phase 3 opens with spells as cards. The three spells that preceded it (portals, the sledgehammer, the ice — 2026-09-17…24, §4.7–§4.9) are its prologue. Phase 2's open items (the generator's plan layer, the walk's revisit list) stay Phase 2 and interleave as the designer sees fit.
  ...
  - **Phase 3.2 — THE CARD UI `[NEXT — designer 2026-09-25: "These little buttons aren't gonna cut it. I wanna take notes from other card wielding games like mtg arena and hearthstone. Probably cast spells by dragging them from the hand to the field"; the proposal is in §4.10 "The card UI"]`.** The hand as a fan of cards under the board, drag to cast with the targets lit and an area's shape under the finger, tap to cast kept, the enemy's hand face-up in its bar and its played card shown for a beat, the draw from the deck stack, the piles, the redraw from the deck. Game layer only.
