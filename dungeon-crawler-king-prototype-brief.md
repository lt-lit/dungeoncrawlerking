...
- Edge-on doors (§10 Phase 2): a door in a wall that runs up the screen after the camera turns needs art of its own per theme; the weak-spot rule (a door in a north–south line reads as cracked stone) cannot survive a rotating camera, since the same door would flip between a leaf and a crack.
